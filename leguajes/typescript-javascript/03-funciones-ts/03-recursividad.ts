...
const arregloDosDimensiones = [[1,2,3,4],[4,5,6,7]];
...
function comparacionDeDimenciones(filasA:number, columnasA:number, filasB:number, columnasB:number): void{
    if(filasA == filasB){
        if(columnasA == columnasB){
            console.log('las matrices');
        }else{
...
function comparacionDeElementos(){
    
}

function main(){
    comparacionDeDimenciones();
}
