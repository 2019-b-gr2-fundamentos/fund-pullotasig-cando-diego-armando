...
function calculadora(){
    const operacion : string = prompt('Selecciona una operacion: "1. Suma", "2. Resta", "3. Multiplicacion", "4. Dividir", "5. terminamos')
    const esSuma : boolean = operacion == 'suma'|| operacion == 'Suma'|| operacion == '1' || operacion == '1. Suma'|| operacion == '1. suma';
    const esResta : boolean = operacion == 'resta'|| operacion == 'Resta'||operacion == '2' || operacion == '2. Resta' || operacion == '2. resta';   
    const esMultiplicacion : boolean = operacion == 'multiplicacion'|| operacion == 'Multiplicacion'||operacion == '3' || operacion == '3. Multiplicacion' || operacion == '3. multiplicacion';
    const esDivision : boolean = operacion == 'division'|| operacion == 'Division'||operacion == '4' || operacion == '4. Division' || operacion == '4. division';
    const seTermino : boolean = operacion == 'terminamos';
    const esValida : boolean = esSuma || esResta || esMultiplicacion || esDivision;
if(esValida){
